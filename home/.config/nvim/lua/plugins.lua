    ...
    { -- themes/ui
        ...
        config = function() 
            ...
            M = {
                ...
                base03 = '#6272a4', -- Comments/Faint Foreground (Editor) -> ANSI 8 (Bright Black/Dark Gray)
                ...
                base08 = '#ff5555', -- Red Accent (Errors, Constants) (Editor) -> ANSI 1 (Red)
                ...
                base0D = '#80bfff', -- Blue Accent (Keywords, Classes) (Editor) -> ANSI 4 (Blue)
